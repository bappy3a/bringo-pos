                ...
                <div class="modal-body">
                    <form id="brand-form" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="brand_description" class="form-control" 
                                      rows="3" placeholder="Enter brand description (optional)" 
                                      maxlength="500"></textarea>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="unit-form" enctype="multipart/form-data" novalidate>
                        @csrf
                        <div class="mb-3">
                            <label for="unit_name" class="form-label fw-bold">Unit Name <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            <label for="unit_allow_decimal" class="form-label fw-bold">Allow Decimal <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="unit_description" class="form-control" 
                                      rows="3" placeholder="Enter unit description (optional)" 
                                      maxlength="500"></textarea>
