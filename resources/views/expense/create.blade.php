...
<div class="page-header">
  ...
  <div class="card">
    <div class="card-body add-product pb-0">
      <form action="{{ route('expenses.store') }}" method="POST" enctype="multipart/form-data" class="row g-3">
        @csrf
        <div class="col-lg-6 col-sm-6 col-12">
          <div class="mb-3 add-product">
            <label class="form-label">Expense Title</label>
            <input type="text" name="title" class="form-control" required placeholder="Enter expense title">
          </div>
        </div>
        <div class="col-lg-6 col-sm-6 col-12">
          <div class="mb-3 add-product">
        ...
        <div class="col-lg-12">
          <div class="mb-3 add-product">
            ...
            <textarea name="description" class="form-control" rows="3" placeholder="Enter expense description"></textarea>
          </div>
        </div>
        <div class="col-lg-6 col-sm-6 col-12">
          <div class="mb-3 add-product">
