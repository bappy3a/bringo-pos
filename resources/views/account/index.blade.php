...
@section('content')
  <div class="page-header">
    ...
    <div class="page-btn">
    <a href="{{ route('accounts.create') }}" class="btn btn-added"><i data-feather="plus-circle" class="me-2"></i>Add
      Account</a>
    </div>
  </div>
  ...
  <div class="card table-list-card">
    ...
    <div class="table-responsive">
      ...
      <td class="action-table-data">
        ...
        <a class="me-2 p-2" href="{{ route('accounts.edit', $account->id) }}"><i data-feather="edit"
        class="feather-edit"></i></a>
        <a class="confirm-text p-2" href="javascript:void(0);"
        onclick="confirm_modal('{{ route('accounts.destroy', $account->id) }}')"><i data-feather="trash-2"
      ...
      <td colspan="7" class="text-center">
        ...
        <a href="{{ route('accounts.create') }}" class="btn btn-primary"><i class="fas fa-plus me-2"></i>Create
        Account</a>
        </div>
      </td>
      </tr>
